...
declare global {
  // @ts-ignore
  export type { AlertTypeValue, AlertType } from '../../shared/types/AlertType'
  import('../../shared/types/AlertType')
  // @ts-ignore
  export type { NewUserType } from '../../shared/types/NewUserType'
  import('../../shared/types/NewUserType')
  // @ts-ignore
  export type { ToastTypeValue, ToastType } from '../../shared/types/ToastType'
  import('../../shared/types/ToastType')
  // @ts-ignore
  export type { UserType } from '../../shared/types/UserType'
  import('../../shared/types/UserType')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/PAP/Kizuna/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/PAP/Kizuna/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';